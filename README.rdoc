...
(e.g. adding a semicolon), you can do so using I18n. Simply add a translation
for show_for.label_wrapper including the value for label. E.g, in show_for.en.yml:
